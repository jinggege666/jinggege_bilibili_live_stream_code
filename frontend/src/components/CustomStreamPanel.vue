  ...
  <div class="panel fade-in">
    ...
    <div class="card config-card">
      ...
      <div class="input-group" style="margin-top: 20px;">
        ...
        <div class="row" style="gap: 8px;">
          <input
            ...
            style="flex: 1;"
          />
          <button class="btn btn-secondary" @click="copyFullUrl" title="复制完整地址">
            复制
          </button>
        </div>
      </div>
      ...
      <div class="input-group" style="margin-top: 12px;">
        ...
        <button class="btn btn-secondary" @click="onSelectFile" style="width: 100%; text-align: left; padding: 0 12px;">
